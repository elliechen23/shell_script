...
echo "35.跨行DVP交易：BANK005-BANK002-A07106-券轉出100000-款轉入10200000"
echo
TRX_ID35=$(curl -s -X POST \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"securityTransfer",
	"args":["S","005000000001" , "002000000001" , "A07106" , "10200000","100000","true"]
}')
echo "Transacton ID is $TRX_ID35"
echo
echo

echo "36.跨行DVP交易：BANK002-BANK005-A07106-券轉入100000-款轉出102000"
echo
...
echo "37.跨行DVP交易：BANK002-BANK004-A07106-券轉出100000-款轉入102000"
echo
...
echo "38.跨行DVP交易：BANK002-BANK004-A07106-券轉入100000-款轉出102000"
echo
...
echo "39.跨行DVP交易：BANK004-BANK005-A07106-券轉出100000-款轉入102000"
echo
...
echo "40.跨行DVP交易：BANK005-BANK004-A07106-券轉入100000-款轉出102000"
echo
...
echo "41.跨行DVP交易券打錯：BANK002-BANK004-A07106-券轉出101000-款轉入102000"
echo
...
echo "42.跨行DVP交易券打錯：BANK004-BANK002-A07106-券轉入100000-款轉出102000"
echo
...
echo "43.跨行DVP交易款打錯：BANK004-BANK005-A07106-券轉出100000-款轉入102000"
echo
...
echo "44.跨行DVP交易款打錯：BANK005-BANK004-A07106-券轉入100000-款轉出101000"
echo
...
echo "45.跨行DVP交易券不足：BANK005-BANK002-A07106-券轉出10000000-款轉入102000"
echo
TRX_ID45=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json" \
  -d '{
...
echo "Transacton ID is $TRX_ID45"
echo
echo

echo "46.跨行DVP交易券不足：BANK002-BANK005-A07106-券轉出100000-款轉入102000--"
echo
TRX_ID46=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json" \
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"securityTransfer",
	"args":["S","002000000001" , "005000000001" , "A07106" , "10200000","100000","true"]
}')
echo "Transacton ID is $TRX_ID46"
echo
echo

echo "47.公債利息更新A07106-2019/06/02應計利息試算"
echo
TRX_ID47=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json" \
  -d '{
...
echo "Transacton ID is $TRX_ID47"
echo
echo


echo "48.公債利息更新A07106-BANK002-2019/06/02應計利息試算"
echo
TRX_ID48=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json" \
  -d '{
...
echo "Transacton ID is $TRX_ID48"
echo
echo

echo "49.公債利息更新A07106-BANK004-2019/06/02應計利息試算"
echo "POST invoke chaincode on peers of Org1"
echo
TRX_ID49=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json" \
  -d '{
...
echo "Transacton ID is $TRX_ID49"
echo
echo

echo "50.公債利息更新A07106-BANK005-2019/06/02應計利息試算"
echo "POST invoke chaincode on peers of Org1"
echo
TRX_ID50=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json" \
  -d '{
...
echo "Transacton ID is $TRX_ID50"
echo
echo



echo "51.readBank BANK002"
echo
curl -s -X GET \
...
echo "55.readAccount 002000000001"
echo
curl -s -X GET \
...
echo "56.readAccount 002000000002"
echo
curl -s -X GET \
...
echo "57.readAccount 004000000001"
echo
curl -s -X GET \
...
echo "58.readAccount 004000000002"
echo
curl -s -X GET \
...
echo "59.readAccount 005000000002"
echo
curl -s -X GET \
...
echo "62.queryAllHistoryTransactions"
echo
curl -s -X GET \
...
echo "64.GET query Block by blockNumber"
echo
curl -s -X GET \
...
echo "65.GET query Transaction by TransactionID"
echo
...
echo "67.GET query Installed chaincodes"
echo
curl -s -X GET \
...
echo "68.GET query Instantiated chaincodes"
echo
curl -s -X GET \
...
echo "Total 69 execution time : $(($(date +%s)-starttime)) secs ..."
